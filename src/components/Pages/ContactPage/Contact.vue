<template>
  ...
  <section
    class="relative z-10 overflow-hidden bg-slate-900 dark:bg-dark py-20 lg:py-[120px]"
  >
    <div class="container mx-auto">
      <div class="flex flex-wrap -mx-4 lg:justify-between">
        ...
        <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
          <div
            class="relative p-8 bg-slate-800 rounded-lg shadow-lg dark:bg-dark-2 sm:p-12"
          >
            <form>
              <div class="mb-6">
                <input
                  ...
                  class="border-stroke dark:border-dark-3 dark:text-dark-6 dark:bg-dark text-body-color focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none bg-slate-900"
                />
              </div>
              <div class="mb-6">
                <input
              ...
              <div class="mb-6">
                <textarea
                  ...
                  class="border-stroke dark:border-dark-3 dark:text-dark-6 dark:bg-dark text-body-color focus:border-primary w-full resize-none rounded border py-3 px-[14px] text-base outline-none bg-slate-900"
                ></textarea>
              </div>
              <div>
                <button
